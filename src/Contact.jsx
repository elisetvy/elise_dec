...
function Contact() {
    ...
    return (
        <div className="h-full flex flex-col justify-between items-center gap-4">
            <div className="relative flex-1 h-3/6 w-full max-w-[400px] border border-[#010602]">
            ...
            <div className="flex-0 h-fit max-w-[400px] bg-white drop-shadow-md text-center px-4 py-4">
