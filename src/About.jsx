function About() {
    ...
    return (
        <div className="h-full bg-white rounded-t-xl overflow-hidden">
            <img className="w-full h-1/2 object-cover" src="https://i.pinimg.com/1200x/24/1f/49/241f49ca612ef379a78fdcf7b8471ada.jpg" alt="cat" />
            <div className="h-1/2 flex flex-col justify-center">
                ...
                <div className="px-4 text-center text-sm"><b>Interests: </b> reading, crocheting, spitting bars in several languages (natural and programming), traveling</div>
            </div>
        </div>
    )
}
